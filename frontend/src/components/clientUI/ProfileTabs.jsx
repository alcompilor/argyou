...
export const ProfileTabs = () => {
    ...
    return (
        <>
            ...
            <div className="mb-8">
                <div
                    className={`pl-20 pr-20 ${activeTab !== "info" && "hidden"} -mt-1`}
                >
                    <div className="bg-gray-100 p-4 text-sm font-bold">
                        <div className="bg-rose-200 rounded p-3 border-gray-200 border-5 w-fit mb-4 mt-1">
                            <h1 className="max-w-lg font-medium mb-3">
                                A passionate debater with a knack for dissecting
                                arguments and crafting compelling narratives. I
                                thrive in the heat of intellectual battles,
                                where facts collide and ideas spark.
                            </h1>
                        </div>
                        {data.data.specialization ? (
                            ...
                            <div className="p-2 rounded-lg bg-gray-700 mb-4 max-w-20">
                                <p className="text-white hover:text-rose-100 duration-300">
                                    Follower
                                </p>
                            </div>
                        )}
                        <h1 className="mb-3 text-rose-600">
                            Email: {data.data.email}
                        </h1>
                        <h1 className="mb-3 text-rose-600">
                            Phone number: +467 931 844-57
                        </h1>
                        <div className="mb-2">
