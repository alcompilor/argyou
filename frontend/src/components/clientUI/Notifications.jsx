...
export const Notifications = () => {
    ...
    useEffect(() => {
        ...
        if (readNotifications) {
            const notifications = userData.data.notifications.map(
                (notification) => ({
                    ...notification,
                    status: "read",
                }),
    ...
    function getDateAndTimeFormat(date) {
        ...
        return (
            notificationTime[0] + " " + notificationTime[1].split(":00.000Z")[0]
        );
    }

    return (
        <li className="relative" onMouseEnter={() => setVisibility(true)}>
