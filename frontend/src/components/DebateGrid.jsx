import { fetchDebates } from "@/services/fetchDebates";
import { useQuery } from "@tanstack/react-query";
import { DebateCard } from "./DebateCard";

export const DebateGrid = () => {
    const { data, error, isLoading, isSuccess } = useQuery({
        queryKey: ["debate-space"],
        ...
        <div className="md:grid md:grid-cols-3 flex flex-col gap-8 p-4 justify-center">
            ...
            {isLoading && (
                <div role="status">
                    <svg
                        aria-hidden="true"
                        className="inline w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-rose-600"
                        viewBox="0 0 100 101"
                        fill="none"
