...
export const SignIn = () => {
    ...
    return (
        <>
          <Meta title={"Argyou | Sign in"} desc={"Sign in to your Argyou account to participate in debates and manage your profile."} imgUrl={`${import.meta.env.VITE_SITE_URL}/default.png`}/>
